...
//   // // //This is getting the model description from the dropdown
  ...
  //console.log("24 Test: pickup: " + document.getElementById('typePickup').checked);

  requestadvSearch.open('GET', 'http://localhost:8080/advVehicleSearch' + "?vehicleMake=" + strMake + "&yearLow=" + strYLower + "&yearHigh=" + strYUpper + "&priceLow=" + strLower + "&priceHigh=" + strUpper +
